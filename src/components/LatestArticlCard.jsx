  ...
  return (
    <div className='bg-white'>
        ...
        <div className='flex flex-col gap-2 px-2 py-4 '>
            ...
            <h1 className='text-[#1D2026] text-[12px] font-[500]'>2021 Complete Python Bootcamp From Zero to Hero...</h1>
       
        <div className='flex  items-center gap-2 pb-5 pt-2  border-t-1 border-[#E9EAF0]'>
            <FaUser color='#FF6636'/>
            <p className='text-[#7B7B7B] text-[12px]'>Mohammad Issa</p>
 </div>
        </div>
    </div>
  )
